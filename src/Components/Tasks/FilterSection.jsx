  ...
  const FilterSection = ({
    ...
    return (
      <div className="sticky top-0 z-20 bg-gray-50 rounded-3xl border-none shadow-md mb-4 px-3 py-2">
        ...
        {/* ✅ Filters - Hamesha visible, koi collapse nahi */}
        <div className="mt-3 grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          {/* Department */}
          ...
          <div className="col-span-1">
           ...
           {isFilterActive && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 h-10 w-30 text-xs font-semibold text-gray-800 shadow-sm hover:bg-gray-50 sm:mt-6"
