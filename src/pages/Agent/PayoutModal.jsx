...
const PayoutModal = ({ agent, onClose, onProcess }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (amount > pendingAmount) {
      if (
        !window.confirm(
          `Warning: The amount ${formatCurrency(
            amount
          )} exceeds the pending balance of ${formatCurrency(
            pendingAmount
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-opacity-70 backdrop-blur-sm">
