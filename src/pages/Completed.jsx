...
import { FaUserTie, FaTasks, FaCalendarAlt, FaHourglassHalf, FaUsers, FaUserCheck, FaSpinner } from "react-icons/fa";
          ...
          <div className="flex items-center gap-2 min-w-[140px]">
            ...
            <div className="flex-1 min-w-[120px]">
              <Select
                ...
                className="text-sm"
                isSearchable
                isDisabled={loading || clientLoading}
          ...
          <div className="flex items-center gap-2 min-w-[140px]">
            ...
            <div className="flex-1 min-w-[120px]">
              <Select
                ...
                className="text-sm"
                isSearchable
                isDisabled={loading || codeLoading}
        ...
        <>
          ...
          <div className="hidden md:block lg:hidden">
            <div className="grid grid-cols-1 gap-3">
              {filteredTasks.length === 0 ? (
                ...
                filteredTasks.map((task, index) => (
                  <div key={task._id} className="bg-white border rounded-lg p-4 shadow hover:shadow-md transition-shadow">
          ...
          <div className="md:hidden flex flex-col gap-3">
            {filteredTasks.length === 0 ? (
              ...
              filteredTasks.map((task, index) => (
                <div key={task._id} className="bg-white shadow rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-semibold">{task.taskName}</span>
                    <span className="text-xs bg-green-200 text-green-700 px-2 py-1 rounded-full">{task.status}</span>
                  </div>
