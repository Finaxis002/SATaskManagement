...
//     fetchInitialData();
//     return () => {
//     console.log("ViewInvoices cleanup");
//   };
//   }, []);
...
//   // Add this to ViewInvoices component
// useEffect(() => {
//   console.log("showEditModal changed:", showEditModal);
//   console.log("invoiceToEdit changed:", invoiceToEdit);
// }, [showEditModal, invoiceToEdit]);

// useEffect(() => {
//   console.log("ViewInvoices rendered");
// });

// // In ViewInvoices component
// useEffect(() => {
//   const invoiceForms = document.querySelectorAll('[class*="InvoiceForm"]');
//   console.log("InvoiceForm instances in DOM:", invoiceForms.length);
// }, [showEditModal]);
              ...
              {filteredInvoices.map((inv) => (
                ...
                >
                  ...
                  <td>
                    ...
                    <button
                      onClick={() => openEdit(inv)}
                      className="ml-2 bg-amber-500 hover:bg-amber-700 text-white px-3 py-1 rounded-md text-sm font-medium transition"
                    >
                      <FaEye />
                    </button>
