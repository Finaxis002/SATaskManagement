...
// import { saveUpdateToDB } from "../utils/wnDB"; // ✅ only keep IndexedDB
...
export default function Updates() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Notify header to reflect updates
  ...
  return (
    <div
  className="
    min-h-[100svh] bg-[#0b1425] text-white
...
>
  ...
  <form
    ...
    className="
      ...
      bg-[#141c2f]/90 backdrop-blur
      rounded-2xl border border-white/10 shadow-xl ring-1 ring-black/5
      p-4 sm:p-6 lg:p-8
      space-y-4 sm:space-y-6
    "
  >
    {/* Title + Tags (stack on mobile, 2-col on md+) */}
    <div className="grid grid-cols-1 md:grid-cols-5 gap-3 sm:gap-5">
      {/* Title */}
      <div className="md:col-span-3">
        <label htmlFor="title" className="block text-xs sm:text-sm mb-1 text-gray-300">
          Title
        </label>
        <input
          id="title"
          ...
          required
          className="
            w-full rounded-lg border border-gray-600/70 bg-gray-800/80 text-white
      ...
      <div className="md:col-span-2">
        <label className="block text-xs sm:text-sm mb-1 text-gray-300">Tags</label>
        <div className="flex flex-col sm:flex-row gap-2">
          <input
            ...
            className="
              flex-1 rounded-lg border border-gray-600/70 bg-gray-800/80 text-white
              placeholder-gray-400
              focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500
              text-sm sm:text-base px-3 py-2.5
            "
    ...
    {/* Details */}
    <div>
      <label htmlFor="details" className="block text-xs sm:text-sm mb-1 text-gray-300">
       Description
      </label>
      <textarea
        id="details"
    ...
    <div className="pt-1 sm:pt-2">
      <button
        ...
        className={`
          ...
          font-semibold
          ${loading ? "bg-gray-500 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700 active:scale-[0.99]"}
